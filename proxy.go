...
func copyHeaders(dst, src http.Header, keepDestHeaders bool) { _ = "STUB: not implemented"; return }
...
func (fw flushWriter) Write(p []byte) (int, error) { _ = "STUB: not implemented"; return 0, nil }
...
func NewProxyHttpServer() *ProxyHttpServer { _ = "STUB: not implemented"; return nil }
